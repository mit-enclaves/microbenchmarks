...
do
  ...
  bin/ubuntu.exe --core-num 2  --mem-size 2048 --ignore-user-stucks 1000000 --rom /mnt/efs/fs1/riscy-OOO/procs/rom/out/rom_core_2 --elf /mnt/efs/fs1/hardware_tests/build/test_rdmem.elf
done
